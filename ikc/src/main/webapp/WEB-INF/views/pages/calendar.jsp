...
<%
  Calendar cal = Calendar.getInstance(TimeZone.getTimeZone("GMT+8"), Locale.CHINESE); //   修改时区和地区 
%>
...
.eventColor1 a {
    background-color: #548C00; /* background color */
    border-color: #548C00;     /* border color */
...
.eventColor2 a {
     background-color: 	#194052; /* background color */
     border-color: 	#194052;     /* border color */
     color: purple;           /* text color */
     }
/* 飲食 */
.eventColor3,
...
.eventColor3 a {
     background-color: #E0A526; /* background color */
     border-color: #E0A526;     /* border color */
     color: purple;           /* text color */
     font-color:black;
     }
			...
			jQuery.ajax({
                ...
                success : function(doc) {
                    $.map(doc, function(b) 
                    	...
                    	b.dietcalories=parseInt(b.dietcalories);
                        event.push({
                            id : "123",
