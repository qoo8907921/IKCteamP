				        ...
				        if (response.authResponse) {
					          ...
					          FB.api('/me',{fields: 'id,name,email'}, function (response) {
					        	  ...
					        	  $.ajax({
					        		  ...
					        		  success:function(e){
					        			  if(e=="success"){
					        				  console.log("successFBlogin");
					        				  var fbid = response.id;
					        				  $('#useraccount').val(fbid);
					        				  gethisdate();
					        			  }
					        		  }
					        	  })
...
<body>
	...
	<!-- 導覽列 -->
	<input value="${membersbean.useraccount}" style="display: none;" id="useraccount">
	<nav id="navbar"
			...
			<div class="collapse navbar-collapse" id="navbarSupportedContent">
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
					 ...
					 <li class="nav-item"><a class="nav-link" href='<c:url value="/pages/TDEEselect" />'>BMR＆TDEE計算</a></li>
                 <li class="nav-item">
	...
	<main>
		...
		<script type="text/javascript">
							...
							function gethisdate(time) {
								$('.addfood').each(function(index,ele){
									$(this).empty().remove();
								})
								if(time!=undefined){
									var fooddate = time;
