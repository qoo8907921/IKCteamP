...
@
keyframes slidein {from { margin-left:100px;
	width: 400px;
	;
}
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					...
					<li class="nav-item dropdown"><a
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
							...
							<li><a class="dropdown-item"
								href='<c:url value="/pages/bodyinformationselect" />'>運動分析</a></li>
							<li><a class="dropdown-item"
								href='<c:url value="/pages/sleeping" />'>睡眠分析</a></li>
							<li>
								<hr class="dropdown-divider">
							</li>
							<li><a class="dropdown-item"
								href='<c:url value="/pages/calendar" />'>我的健康月曆</a></li>
						</ul></li>
					<li class="nav-item"><a class="nav-link"
						href='<c:url value="/pages/TDEEselect" />'>BMR＆TDEE計算</a></li>
					<li class="nav-item"><a class="nav-link"
		...
		<div class="container">
			<div class="row" style="display: flex;">
				<div
					...
					<form action='<c:url value="/pages/sleepinginsert"/>' method="post">
						<input class="date" type="date" name="sleepingdate"
							style="margin-top: 35px; margin-left: 20px;"> <label>你今天睡幾小時？</label><input
							name="sleepinghour" type="text" placeholder="請填入數字"
							style="width: 100px;"><label>&nbsp;小時</label> <input
							type="submit" value="儲存" onclick="save()"
						...
						<a	href="/pages/calendar"><input type="button" value="前往月曆"
							style="margin-left: 200px; margin-top: 20px;"></input> <br>
						</a> 
						
					</form>
					
					<form action='<c:url value="/payments/request"/>' method="post">
						<input type="button">
						...
						<div id="list-wrapper">
							...
							<div class="list-item">
								<p style="font-size: 18px;">
									1.過去一個月來，通常幾點睡覺? <input type="text" placeholder="請填入數字"
										id="minute"
										style="color: #a3a09b; width: 100px; font-size: 16px;">&nbsp;點
								</p>
								<p style="font-size: 18px;">
									2.過去一個月來，通常多久才能入睡？ <input type="text" placeholder="請填入數字"
										id="minute"
										style="color: #a3a09b; width: 100px; font-size: 16px;">&nbsp;分鐘
								</p>
								<p style="font-size: 18px;">
									3.過去一個月來，早上通常幾點起床？<input type="text" placeholder="請填入數字"
										id="minute"
										style="color: #a3a09b; width: 100px; font-size: 16px;">&nbsp;點
								</p>
								<p style="font-size: 18px;">
									4.過去一個月來，睡眠時間大約幾小時？<input type="text" placeholder="請填入數字"
										id="minute"
										style="color: #a3a09b; width: 100px; font-size: 16px;">&nbsp;點
								</p>
							...
							<div class="list-item">
								...
								<div
									...
									<div class="sheet" id="sheet" style="font-size: 18px;">
										<label style="margin: 5px;">a.無法在30分鐘以內入睡</label> <select
											style="color: gray; font: size 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">b.半夜或清晨醒來</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">c.起床上廁所</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">d.起床上廁所</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">e.咳嗽或打呼</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">f.感覺很冷</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">g.感覺很熱</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">h.做惡夢</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option>每週3次</option>
										</select><br> <label style="margin: 5px;">i.疼痛</label> <select
											style="color: gray; font-size: 16px;">
											<option>從未發生</option>
											<option>每週少於1次</option>
											<option>每週1-2次</option>
											<option style="color: brown">每週3次</option>
										</select><br> <input type="submit" id="next" value="檢測結果"
											onclick="lastpage()"
				...
				<div class="row container-right col-lg-7">
					<div id="sleepfood" class="sleepfood "
						...
						<div>
							<h4 style="text-align: center; margin-top: 50px; color: #59554c">幫助入睡七大營養素</h4>
							<br>
							<div id="nutrition" style="width: 600px;">
								<div id="trp"
									...
									<div class="trpfood"
										...
										<p
											style="font-size: 22px; margin: 24px; color: rgb(111, 108, 104);">
											富含色胺酸的食物：<br>
										</p>
										<img src="../img/trpfood.png" style="height: 400px;">
								...
								<div id="vitB"
									...
									<h6 style="padding: 10px; font-size: 20px;">維生素B群</h6>
									<br>
									<div class="vitB"
										style="z-index: 3; position: absolute; margin-left: 150px; width: 400px; height: 550px; background-color: rgb(220, 236, 236); border-radius: 1rem;">
										<p
										...
										<img src="../img/vitB.jpg" style="height: 450px;">
									</div>
								</div>
								<div id="GABA"
									style="text-align: center; background-color: aliceblue; margin-left: 100px; margin-bottom: 30px; font-size: 20px; width: 120px; height: 50px; border-radius: 1rem;">
									<h6 style="padding: 10px; font-size: 20px;">GABA</h6>
									<br>
									<div class="GABA"
										style="z-index: 3; position: absolute; margin-left: 150px; width: 400px; height: 550px; background-color: rgb(220, 236, 236); border-radius: 1rem;">
										<p
										...
										<img src="../img/GABAfood.png" style="height: 450px;">
									</div>
								</div>
								<div id="K"
									...
									<h6 style="padding: 10px; font-size: 20px;">鉀</h6>
									<br>
									<div class="K"
										style="z-index: 3; position: absolute; margin-left: 150px; width: 400px; height: 550px; background-color: rgb(220, 236, 236); border-radius: 1rem;">
										<p
										...
										<img src="../img/Kfood.png"
											style="height: 450px; width: 300px;">
									</div>
								</div>
								<div id="Ca"
									style="text-align: center; background-color: aliceblue; margin-left: 100px; margin-bottom: 30px; font-size: 20px; width: 100px; height: 50px; border-radius: 1rem;">
									<h6 style="padding: 10px; font-size: 20px;">鈣</h6>
									<br>
									<div class="Ca"
										style="z-index: 3; position: absolute; margin-left: 150px; width: 400px; height: 550px; background-color: rgb(220, 236, 236); border-radius: 1rem;">
										<p
										...
										<img src="../img/Cafood.png" style="height: 350px;">
									</div>
								</div>
								<div id="Mg"
									style="text-align: center; background-color: aliceblue; margin-left: 100px; margin-bottom: 30px; font-size: 20px; width: 100px; height: 50px; border-radius: 1rem;">
									<h6 style="padding: 10px; font-size: 20px;">鎂</h6>
									<br>
									<div class="Mg"
										style="z-index: 3; position: absolute; margin-left: 150px; width: 400px; height: 550px; background-color: rgb(220, 236, 236); border-radius: 1rem;">
										<p
										...
										<img src="../img/Mgfood.png" style="height: 450px;">
									</div>
								</div>
								<a href="/shop_all/ec_p1_main.html">
									<p
										style="font-size: 22px; padding-left: 100px; padding-top: 60px;">
										更多助眠相關保健食品<img src="../img/finger.png" style="width: 50px;">歡迎至商城逛逛！
									</p>
								</a>
							</div>
						</div>
	...
	<script>
        ...
        function lastpage() {
      	...
      	function test111(){
                  ...
                  json: true,
                  headers: {
                  'X-LINE-ChannelId': 1657234235,
                  'X-LINE-ChannelSecret': 5f098b48a13fe6353a517e9300f503dc
                  },
                  body: {
                  "amount": 100,
                  "productName": "ithome",
      ...
      est atque cumque eum delectus sint!
				...
				<div class="col-lg-2 col-md-6 mb-4">
					...
					<ul class="list-unstyled mb-0">
						<li class="mb-1"><a href='<c:url value="/pages/FAQ" />'
							style="color: #4f4f4f;">FAQs</a></li>
					</ul>
				</div>
				...
				<div class="col-lg-2 col-md-6 mb-4">
					...
					<ul class="list-unstyled mb-0">
						<li class="mb-1"><a href='<c:url value="/pages/aboutus" />'
							style="color: #4f4f4f;">關於我們</a></li>
						<li class="mb-1"><a href='<c:url value="/pages/policy" />'
							style="color: #4f4f4f;">隱私權政策</a></li>
					</ul>
				</div>
